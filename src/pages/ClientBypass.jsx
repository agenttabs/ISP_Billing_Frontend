                    ...
                    <CardContent>
                      <Stack spacing={1}>
                        ...
                        <Box sx={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 0.75 }}>
                          <Box>
                            <Typography sx={{ color: "#64748b", fontSize: "0.63rem", fontWeight: 800 }}>MAC</Typography>
                            <Typography sx={{ fontWeight: 800, wordBreak: "break-word" }}>{row.MacAddress || "-"}</Typography>
                          </Box>
                          <Box>
                        ...
                        <Typography sx={{ color: "#64748b", fontSize: "0.75rem", wordBreak: "break-word" }}>
                          Added by: {row.CreatedBy || row.CreatedById || "-"}
                        </Typography>
                      </Stack>
                    </CardContent>
                  </Card>
